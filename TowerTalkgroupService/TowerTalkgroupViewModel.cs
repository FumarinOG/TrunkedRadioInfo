...
{
    public sealed class TowerTalkgroupViewModel
    {
        ...
        public TowerTalkgroupViewModel()
        {
        }

        public TowerTalkgroupViewModel(int talkgroupID, string talkgroupName, DateTime firstSeen, DateTime lastSeen, int affiliationCount, int deniedCount,
